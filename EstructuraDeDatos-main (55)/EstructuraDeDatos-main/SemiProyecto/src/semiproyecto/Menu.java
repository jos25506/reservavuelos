        ...
        try {
            ...
            switch (index) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    int cajaMasClientes = ContadorReportes.getCajaConMasClientes();
                    int totalAtendidos = ContadorReportes.getTotalClientesAtendidos();
                    int mejorCaja = ContadorReportes.getCajaConMejorPromedio();
                    double promedioGeneral = ContadorReportes.getPromedioGeneral();
